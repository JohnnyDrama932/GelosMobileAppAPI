...
namespace GelosMobileAppAPI.Models;
...
public partial class RoiDatabaseContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Departme__3214EC0767A8878A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__People__3214EC07D3B0036D");
